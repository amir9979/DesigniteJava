...
public class CSVUtils {
	...
	private static void initializeNeededFiles(File dir) {
		...
		createCSVFile(dir.getPath() + File.separator + Constants.ORGANIC_TYPE_CODE_SMELLS_PATH_SUFFIX, Constants.ORGANIC_TYPE_CODE_SMELLS_HEADER);
		createCSVFile(dir.getPath() + File.separator + Constants.ORGANIC_METHOD_CODE_SMELLS_PATH_SUFFIX, Constants.ORGANIC_METHOD_CODE_SMELLS_HEADER);
	}
